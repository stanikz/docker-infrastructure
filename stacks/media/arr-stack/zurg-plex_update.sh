#!/bin/bash
#This file should be inside zurg folder with config.yml
...
plex_url="http://192.168.10.90:32400" # If you're using zurg inside a Docker container, by default it is 172.17.0.1:32400
token="${PLEX_TOKEN}" # open Plex in a browser, open dev console and copy-paste this: window.localStorage.getItem("myPlexAccessToken")
zurg_mount="/mnt/media/arrs/zurg-mount" # replace with your zurg mount path, ensure this is what Plex sees
